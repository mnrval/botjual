...
Ex : ${usedPrefix + command} https://www.mediafire.com/file/pwxob70rpgma9lz/GBWhatsApp_v8.75%2528Tutorial_Yud%2529.apk/file*`
	...
	if (baby1.filesize.split('MB')[0] >= 100) return m.reply('*File Over Limit* ' + util.format(baby1))
...
`
	conn.sendFile(m.chat, baby1.link || emror, `${baby1.filename}`, '', m, null, { mimetype: `${baby1.filetype}`, asDocument: true })
}
