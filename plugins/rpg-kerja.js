let handler = async (m, { conn, command, args, usedPrefix }) => {
    ...
    let time = global.db.data.users[m.sender].lastjb + 21600000
    ...
    if (/kerjadulu|kerja|work/i.test(command)) {
        switch(type) {
            case 'ojek':
                ...
                if (new Date() - global.db.data.users[m.sender].lastkerja < 21600000)  throw `Kamu Sudah Bekerja\nSaatnya Istirahat Selama ${clockString(time - new Date())}`
            ...
            case 'pedagang':
                ...
                if (new Date() - global.db.data.users[m.sender].lastkerja < 21600000)  throw `Kamu Sudah Bekerja,Saatnya Istirahat Selama\n${clockString(time - new Date())}`
            ...
            case 'montir':
                ...
                if (new Date() - global.db.data.users[m.sender].lastkerja < 21600000)  throw `Kamu Sudah blBekerja,Saatnya Istirahat Selama\n${clockString(time - new Date())}`
