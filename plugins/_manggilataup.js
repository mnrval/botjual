var handler = async (m, { conn, usedPrefix: _p }) => {
  ...
  if (text === 'p' || text === 'pe' || text === 'woy' || text === 'cuk' || text === 'coy' || text === 'cuy' || text === 'cok' || text === 'woi' || text === '🗿' || text === 'tol' || text === 'mek' || text === 'pepek' || text === 'ngen' || text === 'ngentot') {
...
handler.customPrefix = /^(kakak|p|om|om xnuvers|om sora|pe|woy|cuk|cok|coy|woi|cuy|bapak|pak|ibu|bu|min|admin|🗿|tol|mek|pepek|ngen|ngentot)$/i;
