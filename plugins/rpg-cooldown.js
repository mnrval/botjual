...
let handler = async (m, { conn, usedPrefix }) => {
	...
	let { lasthourly, lastberburu, lastbansos, lastadventure, lastfishing, lastwar, lastduel, lastmining, lastdungeon, lastclaim, lastweekly, lastmonthly, lastyearly } = global.db.data.users[m.sender]
