...
let handler = async (m, { conn, text, command, usedPrefix }) => {
  let imgr = 'https://i.ibb.co/41ZrKWs/acbcae5e05f77aa2208baa00e8d0598e.jpg';

  conn.quizz = conn.quizz ? conn.quizz : {};
  let id = m.chat;

  if (!text) {
    return m.reply(`Please use this command like this: ${usedPrefix}quizz easy/medium/hard`);
  }
